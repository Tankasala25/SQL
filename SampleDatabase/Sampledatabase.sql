...
IF OBJECT_ID('productlines', 'U') IS NOT NULL DROP TABLE productlines;
GO
...
CREATE TABLE productlines (
  ...
  htmlDescription VARCHAR(MAX), -- Replaces MEDIUMTEXT
  image VARBINARY(MAX) -- Replaces MEDIUMBLOB
);
GO
